...
test.describe('Online Store Landing Page Tests', () => {
  ...
  test('Product Categories Filter and Sorting Check', async ({ page }) => {
    ...
    await page.click('button.inline-flex.items-center.lg\\:hidden');
    await page.waitForTimeout(1000);

    console.log('Opening the Categories section...');
    await page.click('button#headlessui-disclosure-button-3');
    await page.waitForTimeout(1000);

    console.log('Selecting the Edging category...');
    await page.click('label[for="dGVybTo2NA==-0-mobile"]');
    await page.waitForTimeout(1000);
    ...
    await page.click('label[for="dGVybTozMQ==-1-mobile"]');
    await page.waitForTimeout(1000);
    ...
    await page.click('label[for="dGVybToyNg==-2-mobile"]');
    await page.waitForTimeout(1000);
